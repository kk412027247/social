package com.wangluoguimi.social.authService.service;

import com.wangluoguimi.social.authService.client.FacebookClient;
import com.wangluoguimi.social.authService.exception.InternalServerException;
...
import com.wangluoguimi.social.authService.model.facebook.FacebookUser;
...
public class FacebookService {
  ...
  public String loginUser(String fbAccessToken) {
    FacebookUser facebookUser = this.facebookClient.getUser(fbAccessToken);
    return userService.findById(facebookUser.getId())
        .or(() -> Optional.ofNullable(this.userService.registerUser(convertTo(facebookUser), Role.FACEBOOK_USER)))
  ...
  private User convertTo(FacebookUser facebookUser) {
    return User.builder()
        ...
        .userProfile(Profile
            .builder()
            .displayName(String.format("%s %s", facebookUser.getFirstName(), facebookUser.getLastName()))
